...
const en: Dict = {
  ...
  "track.pay.title": "Fee payment pending",
  "track.pay.desc": "Departmental verification is complete. Pay the service fee to continue to Finance.",
  "track.pay.button": "Pay now",
  "track.pay.mark": "I have paid",
  "track.pay.note": "Test mode — the payment gateway link is a placeholder.",
  ...
  "staff.err.generate": "Could not generate the certificate. Please check the fields.",
  "staff.cert.title": "Certificate details",
  "staff.cert.hint": "These values are printed on the generated certificate. Leave the upload empty to auto-generate it.",
  "staff.cert.generate": "Generate & approve",
  "staff.cert.serial_no": "Serial / dispatch no.",
  "staff.cert.issue_date": "Date of issue",
  "staff.cert.father_name": "Father's name",
  "staff.cert.semester": "Semester",
  "staff.cert.session": "Session (e.g. 2023-24)",
  "staff.cert.division": "Division",
  "staff.cert.academic_year": "Academic year",
  "staff.cert.fee_amount": "Fee deposited (Rs.)",
  "staff.uploadLabel": "Optional upload — overrides the generated certificate",
...
const hi: Dict = {
  ...
  "track.pay.title": "शुल्क भुगतान लंबित",
  "track.pay.desc": "विभागीय सत्यापन पूर्ण हो गया है। आगे बढ़ने के लिए सेवा शुल्क का भुगतान करें।",
  "track.pay.button": "अब भुगतान करें",
  "track.pay.mark": "मैंने भुगतान कर दिया है",
  "track.pay.note": "परीक्षण मोड — भुगतान गेटवे लिंक अस्थायी है।",
  ...
  "staff.err.generate": "प्रमाणपत्र नहीं बन सका। कृपया फ़ील्ड जाँचें।",
  "staff.cert.title": "प्रमाणपत्र विवरण",
  "staff.cert.hint": "ये मान बने प्रमाणपत्र पर छपेंगे। स्वतः बनाने के लिए अपलोड खाली छोड़ें।",
  "staff.cert.generate": "बनाएँ और स्वीकृत करें",
  "staff.cert.serial_no": "क्रम / प्रेषण संख्या",
  "staff.cert.issue_date": "जारी करने की तिथि",
  "staff.cert.father_name": "पिता का नाम",
  "staff.cert.semester": "सेमेस्टर",
  "staff.cert.session": "सत्र (जैसे 2023-24)",
  "staff.cert.division": "श्रेणी",
  "staff.cert.academic_year": "शैक्षणिक वर्ष",
  "staff.cert.fee_amount": "जमा शुल्क (रु.)",
  "staff.uploadLabel": "वैकल्पिक अपलोड — बने प्रमाणपत्र को बदल देगा",
